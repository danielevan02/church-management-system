...
export default async function ReportsPage() {
  ...
  return (
    <div suppressHydrationWarning data-stagger="sections" className="flex flex-col gap-6">
      <PageHeader
        eyebrow={tEyebrow("reports")}
        title={t("title")}
        subtitle={t("subtitle", { date: format(new Date(), "dd MMM yyyy") })}
      />
      ...
      <BlockSection
        ...
        staggerChildren
      >
        <div suppressHydrationWarning data-stagger="cards" className="grid grid-cols-2 gap-4 md:grid-cols-4">
      ...
      <BlockSection
        icon={UsersRound}
        title={t("cellGroups.title")}
        description={t("cellGroups.subtitle")}
        staggerChildren
      >
        <div suppressHydrationWarning data-stagger="cards" className="grid grid-cols-2 gap-4 md:grid-cols-4">
          <Stat
      ...
      <BlockSection
        ...
        description={t("discipleship.subtitle")}
        bodyClassName="flex flex-col gap-4"
        staggerChildren
      >
        <div suppressHydrationWarning data-stagger="cards" className="grid grid-cols-2 gap-4">
          <Stat
...
function Stat({
  ...
  return (
    <div className="flex flex-col gap-1 rounded-2xl p-3 bg-surface-container-high">
