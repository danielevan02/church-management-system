...
export default async function MemberDetailPage({
  ...
  const [attendanceHistory, rsvpHistory, milestones, visits] =
    await Promise.all([
    ...
    <div suppressHydrationWarning data-stagger="sections" className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="profile" className="w-full min-w-0">
        ...
        <TabsContent value="profile" className="mt-6">
          <div suppressHydrationWarning data-stagger="cards" className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <BlockSection
            ...
            {member.notes ? (
              <BlockSection
                ...
                bodyClassName="text-sm whitespace-pre-wrap"
              >
                {member.notes}
              </BlockSection>
            ) : null}
