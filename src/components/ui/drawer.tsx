...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-scrim/32 data-[state=open]:m3-scrim-enter data-[state=closed]:m3-scrim-exit",
        className
      )}
      {...props}
    />
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        {/* M3 bottom-sheet drag handle: 32x4dp, on-surface-variant. */}
        <div className="mx-auto mt-4 hidden h-1 w-8 shrink-0 rounded-full bg-on-surface-variant group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
